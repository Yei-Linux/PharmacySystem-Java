...
import Presentacion.Vista_Cliente.Lamina2_Form_Cliente;


public class Consulta_Venta extends JFrame{
	public Lamina2_Form_Venta lamina2 =new Lamina2_Form_Venta();
...
class Lamina2_Form_Venta extends JPanel{
		...
		public Lamina2_Form_Venta(){
			
			boton_buscar=new JButton(buscar);
			
			setLayout(new con_vista_EnColumnas2_3());
		...
		public void Mostrar(String buscar){
			try{
				...
				Metodo_Consulta_Venta func=new Metodo_Consulta_Venta();
...
class con_vista_EnColumnas2_3 implements LayoutManager{
