...
class Lamina2_Form_Cliente extends JPanel{
		...
		private JLabel lab_Listado_Cliente=new JLabel("LISTADO DE CLIENTES");
		...
		public Lamina2_Form_Cliente(){
			...
			setLayout(new form_vista_EnColumnas2_3());
		...
		public void Mostrar(String buscar){
			try{
				...
				Metodo_form_cliente func=new Metodo_form_cliente();
		...
		private class Evento_click implements MouseListener{
			...
			public void mouseClicked(MouseEvent e) {
				if(e.getSource()==tabla){
					...
					valor=tabla.getValueAt(fila, 3).toString()+ " " +tabla.getValueAt(fila, 2).toString();
					
					Vista_Cliente.this.dispose();

					Form_Venta.id_Cliente.setText(cod);
					Form_Venta.Cliente.setText(valor);
...
class form_vista_EnColumnas2_3 implements LayoutManager{
