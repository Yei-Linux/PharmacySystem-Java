...
import Logica.Metodo_form_Sede;
import Logica.MiRender;
import Presentacion.Vista_Proveedor.Lamina2_Form_Proveedor;


public class Vista_Sede extends JFrame{
	...
	class Lamina2_Form_Sede extends JPanel{
		...
		private JLabel lab_Listado_Prod=new JLabel("LISTADO DE SEDES");
		
		private JTextField Proveedor=new JTextField(10);
		
		public Lamina2_Form_Sede(){
			setLayout(new form_vista_sede());
		...
		public void Mostrar(String buscar){
			try{
				...
				Metodo_form_Sede func=new Metodo_form_Sede();
		...
		private class Evento_click implements MouseListener{
			...
			public void mouseClicked(MouseEvent e) {
					...
					Vista_Sede.this.dispose();
					
					Form_Compra.id_Sede.setText(cod);
					Form_Compra.Sede.setText(valor);
...
class form_vista_sede implements LayoutManager{
