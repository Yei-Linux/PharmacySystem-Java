...
import Presentacion.Vista_Producto.Lamina2_Form_producto;


public class Vista_ProductoC extends JFrame{
	...
	class Lamina2_Form_producto extends JPanel{
		...
		public Lamina2_Form_producto(){
			setLayout(new form_vista_prod2c());
		...
		private class Evento_click implements MouseListener{
			...
			public void mouseClicked(MouseEvent e) {
					...
					Vista_ProductoC.this.dispose();
					
					Form_Compra.id_Producto.setText(cod);
					Form_Compra.Producto.setText(valor);
					Form_Compra.Stock.setText(valor2);
					Form_Compra.Precio.setText(valor3);
					Form_Compra.Igv.setText(valor4);
...
class form_vista_prod2c implements LayoutManager{
